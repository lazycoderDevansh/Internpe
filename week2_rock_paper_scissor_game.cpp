...
int main(){
    ...
    do{
        ...
        cout<<endl;
        ai_throw=(rand()%3)+1;
        if(ai_throw== ROCK) cout<<"AI throws ROCK."<<endl;
        else if(ai_throw== PAPER) cout<<"AI throws PAPER"<<endl;
        else if(ai_throw== SCISSORS) cout<<"AI throws SCISSORS"<<endl;
